package com.inspeeding.shenzhen.weiwen.view.adressBook;
...
/**
 * Created by nullWolf on 2018/12/11.
 */
public class SideBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < A_Z.length; i++) {
            paint.setColor(Color.rgb(33, 33, 33));  //设置字体颜色
            paint.setTypeface(Typeface.DEFAULT_BOLD);  //设置字体
            paint.setAntiAlias(true);  //设置抗锯齿
            paint.setTextSize(34);  //设置字母字体大小
            // 选中的状态
            if (i == choose) {
